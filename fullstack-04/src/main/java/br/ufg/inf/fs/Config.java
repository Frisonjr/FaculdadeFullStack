...
public class Config  implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Hospede hs1 = hospedeRepository.save(new Hospede(null, "João",LocalDate.of(1997, 5, 9 ), 123456));
		Hospede hs2 = hospedeRepository.save(new Hospede(null, "José",LocalDate.of(1997, 5, 9 ), 123456));
		Hospede hs3 = hospedeRepository.save(new Hospede(null, "Carlos",LocalDate.of(1997, 5, 9 ), 123456));
		Hospede hs4 = hospedeRepository.save(new Hospede(null, "Carla",LocalDate.of(1997, 5, 9 ), 123456));
